...
export const RANK_CONFIG: Record<RankType, RankInfo> = {
  ...
  middle: { name: '科长', points: 500, color: '#3b82f6', icon: '📋', avatar: 'https://tomatoclock.onrender.com/static/ranks/middle.png' },
  senior: { name: '处长', points: 1000, color: '#8b5cf6', icon: '🏢', avatar: 'https://tomatoclock.onrender.com/static/ranks/senior.png' },
  expert: { name: '副局长', points: 1500, color: '#f59e0b', icon: '⭐', avatar: 'https://tomatoclock.onrender.com/static/ranks/expert.png' },
  master: { name: '局长', points: 2000, color: '#ef4444', icon: '👑', avatar: 'https://tomatoclock.onrender.com/static/ranks/master.png' }
}
